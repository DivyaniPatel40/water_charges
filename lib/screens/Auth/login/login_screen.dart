...
class _LoginScreenState extends State<LoginScreen> {
  ...
  _buildLoginScreen(MediaQueryData queryData) {
    return Column(
      ...
      children: [
        SizedBox(height: 150,),
        Center(child: Text(tr("let_sign_in"),style: TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.bold),textAlign:TextAlign.center,)),
        // Padding(
              ...
              Align(
                ...
                child: GestureDetector(
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (ctx) => reset_password_screen(),
                    ),
                  ),
