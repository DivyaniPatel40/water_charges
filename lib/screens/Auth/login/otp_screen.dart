...
import 'package:untitled/screens/Auth/login/newpassword_screen.dart';
    ...
    return Center(
      child: Column(
        ...
        children: [
          Center(child: Column(
            children: [
              Text(tr("reset_password_sent"),style: TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.bold),textAlign:TextAlign.center,),
              Padding(
                padding: const EdgeInsets.only(left: 50.0,right: 50,top: 7),
                child: Text(tr("please_check_your_email"),maxLines: 2,style: TextStyle(color: Colors.grey,fontSize: 15,),textAlign:TextAlign.center,),
              )
            ],
          )),
